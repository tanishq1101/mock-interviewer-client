    ...
    if (type === "ai") {
        return (
            <div className="animate-fade-in" style={{ display: "flex", alignItems: "start", gap: 10, marginBottom: 12 }}>
                ...
                <div style={{ padding: "12px 16px", borderRadius: "12px 12px 12px 4px", maxWidth: "90%", background: "var(--bg-card)", border: "1px solid var(--border-subtle)" }}>
    ...
    if (type === "user") {
        return (
            <div className="animate-fade-in" style={{ display: "flex", justifyContent: "flex-end", marginBottom: 12 }}>
                <div style={{ padding: "12px 16px", borderRadius: "12px 12px 4px 12px", maxWidth: "90%", background: "rgba(124,58,237,0.12)", border: "1px solid rgba(124,58,237,0.2)" }}>
                    <p style={{ fontSize: 14, lineHeight: 1.7, whiteSpace: "pre-wrap", color: "var(--text)" }}>{content}</p>
                </div>
            </div>
        );
    ...
    if (type === "evaluation") {
        return (
            <div className="animate-fade-in" style={{ display: "flex", alignItems: "start", gap: 10, marginBottom: 12 }}>
                ...
                <div style={{ padding: "12px 16px", borderRadius: "12px 12px 12px 4px", maxWidth: "90%", background: "rgba(167,139,250,0.04)", border: "1px solid rgba(167,139,250,0.15)" }}>
    ...
    if (type === "error") {
        return (
            <div className="animate-fade-in" style={{ display: "flex", justifyContent: "center", marginBottom: 12 }}>
                <div style={{
                    padding: "10px 16px", borderRadius: 10, maxWidth: "90%",
