...
export default function Hero() {
    ...
    return (
        <section
            className="pt-24 pb-12 md:pt-36 md:pb-20"
            style={{ position: "relative", overflow: "hidden", background: "var(--bg)" }}
        >
            {/* Background blobs */}
            <div style={{ position: "absolute", inset: 0, pointerEvents: "none", overflow: "hidden" }}>
                <motion.div
                    style={{ position: "absolute", top: -20, left: -100, width: 400, height: 400, borderRadius: "50%", filter: "blur(120px)", background: "rgba(124,58,237,0.05)", willChange: "transform" }}
                    animate={{ y: [0, -12, 0], x: [0, 8, 0] }}
                    transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
                />
                <motion.div
                    style={{ position: "absolute", top: 150, right: -100, width: 350, height: 350, borderRadius: "50%", filter: "blur(120px)", background: "rgba(124,58,237,0.03)", willChange: "transform" }}
                    animate={{ y: [0, 12, 0], x: [0, -8, 0] }}
            ...
            >
                ...
                <motion.div variants={fadeUp} style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: 12, flexWrap: "wrap", marginBottom: 40 }}>
                    <button
                        ...
                        className="btn-primary animate-pulse-glow px-6 py-2.5 sm:px-8 sm:py-3.5"
                        style={{ fontSize: 14 }}
                    >
                    ...
                    <button
                        className="btn-secondary px-6 py-2.5 sm:px-8 sm:py-3.5"
                        style={{ fontSize: 14 }}
                        onClick={() => {
